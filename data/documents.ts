...
export const documents: CredentialDocument[] = [
  ...
  { id: "venice-florence-italo-1", type: "pdf", titleZh: "威尼斯 → 佛罗伦萨高铁票", titleEn: "Venezia S. Lucia → Firenze S. M. Novella", category: "transport", date: "2026-10-02", time: "14:05", city: "Venezia / Firenze", amount: "€42.90", displayFileName: "Venezia-Firenze-Italo-1.pdf", storage: { kind: "signed", endpoint: "/api/credentials/venice-florence-italo-1" } },
  { id: "venice-florence-italo-2", type: "pdf", titleZh: "威尼斯 → 佛罗伦萨高铁票（同行人）", titleEn: "Venezia S. Lucia → Firenze S. M. Novella", category: "transport", date: "2026-10-02", time: "14:05", city: "Venezia / Firenze", displayFileName: "Venezia-Firenze-Italo-2.pdf", storage: { kind: "signed", endpoint: "/api/credentials/venice-florence-italo-2" } },
